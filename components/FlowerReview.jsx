...
const FlowerReview = ({FlowerReviews}) => {
 

    const [currentTestimonial, setCurrentTestimonial] = useState(0)
    console.log("red",FlowerReviews)
    return (
                                    ...
                                    <li key={idx}>
                                        <figure>
                                            ...
                                            <div className="mt-6">
                                                ...
                                                <div className="mt-3">
                                                    <span className="block text-gray-800 font-semibold">{item.reviewer}</span>
